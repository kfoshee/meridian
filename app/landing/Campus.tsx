...
export const CHAPTERS = [
  ...
  { n: 4, name: "Flexible hall", spec: "40 MW · separable", we: "Turns off when the grid is tight.", gold: true },
      ...
      <div className="campus-side">
        <div className="chapter" key={active ?? "none"}>
          {active ? (<>
            ...
            {done && <div className="chapter-we">40 of 96 MW can turn off. The rest never does. Hover any part.</div>}
          </>)}
        </div>
        <ol className="legend">
          {CHAPTERS.map(l => (
